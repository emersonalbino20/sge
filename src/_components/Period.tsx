...
import { AlertCircleIcon, CheckCircleIcon, EditIcon, PrinterIcon, SaveIcon, Search, AlertTriangle, Loader} from 'lucide-react'
    ...
    <>
      <Dialog >
            ...
            <DialogContent className="sm:max-w-[425px] bg-white">
                  <DialogHeader>
                  <DialogTitle className='text-blue-600 text-xl'>Actualizar Turno</DialogTitle>
                <DialogDescription>
            ...
            />
                ...
                <div className="flex flex-col w-full py-4 bg-white">
                  ...
                  render={({field})=>(
                    ...
                    <Input
                      id="nome"
                      type='text' {...field} className={formUpdate.formState.errors.nome?.message && `
                ...
                <div className="w-full">
                <label htmlFor="inicio">Ínicio<span className='text-red-500'>*</span>
                </label>
                  <FormField
                  control={formUpdate.control}
                  name="inicio"
                  render={({field})=>(
                    ...
                    <Input
                      id="inicio"
                      type='text' {...field} className={formUpdate.formState.errors.inicio?.message && `
                      ${animateShake} input-error`}
                ...
                <div className="w-full">
                <label htmlFor="termino">Término<span className='text-red-500'>*</span>
            </label>
                  <FormField
                  control={formUpdate.control}
                  name="termino"
                  render={({field})=>(
                    ...
                    <Input
                      id="termino"
                      type='text' {...field} className={formUpdate.formState.errors.termino?.message && `
                      ${animateShake} input-error`}
                      placeholder='00:00:00'/>
                    <FormMessage className='text-red-500 text-xs'/>
                  </FormItem>
     ...
     <div className="w-full bg-white p-4 rounded-lg shadow">
      ...
      <div className='flex flex-row space-x-2'>
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px] bg-white">
            <DialogHeader>
            <DialogTitle className='text-blue-600 text-xl'>Cadastrar Turno</DialogTitle>
            <DialogDescription>
                <p className='text-base text-gray-800'>
          ...
          <div className="flex flex-col w-full py-4 bg-white">
              ...
              <label htmlFor="nome">Nome<span className='text-red-500'>*</span>
                ...
                render={({field})=>(
                  ...
                  <Input
                    id="nome"
                    type='text' {...field}  className={formCreate.formState.errors.nome?.message && `
                    ${animateShake} input-error`} 
                    />
                  <FormMessage className='text-red-500 text-xs'/>
                </FormItem>
              ...
              <label htmlFor="inicio">Ínicio<span className='text-red-500'>*</span>
                ...
                render={({field})=>(
                  <FormItem>
                  <Input id="inicio" type='text' {...field}  className={formCreate.formState.errors.inicio?.message && `
                      ${animateShake} input-error`}/>
                  <FormMessage className='text-red-500 text-xs'/>
                </FormItem>
              )}/>
              ...
              <label htmlFor="termino">Término<span className='text-red-500'>*</span>
                ...
                render={({field})=>(
                  <FormItem>
                  <Input id="termino" type='text' {...field}  className={formCreate.formState.errors.termino?.message && `
                      ${animateShake} input-error`} 
                  placeholder='00:00:00'/>
                  <FormMessage className='text-red-500 text-xs'/>
                </FormItem>
        ...
        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
          ...
          <div>
            <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
              ...
              {dados?.data?.data?.length > 0 && [...Array(totalPaginas)].map((_, i) => (
                <button
                  key={i}
