...
import {
  ...
  useGetIdClassRoomdQuery,
  usePostClassRoom,
  usePostClassToClassRoom,
  usePutClassRoom,
} from '@/_queries/UseClassRoomQuery';
...
export default function ClassRoom() {
  ...
  const { postClass, postClassError, postClassLevel } =
    usePostClassToClassRoom();
  const handleSubmitClassToClassRoom = async (
    data: z.infer<typeof TformClassToClassRoom>,
    e
  ) => {
    e.preventDefault();
    postClass(data);
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <p className="text-base text-gray-800">
                altere uma informação da sala e em seguida click em{' '}
          ...
          <Form {...formUpdate}>
            <form onSubmit={formUpdate.handleSubmit(handleSubmitUpdate)}>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Input
                          ...
                          {...field}
                          className={
                            formUpdate.formState.errors.capacidade?.message &&
                            `${animateShake} input-error`
                          }
                          min={0}
                          onChange={(e) => {
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Textarea
                          ...
                          {...field}
                          className={
                            formUpdate.formState.errors.localizacao?.message &&
                            `${animateShake} input-error `
                          }
                        />
                        <FormMessage className="text-red-500 text-xs" />
              ...
              <DialogFooter>
                <Button
                  title="actualizar"
                  className="responsive-button bg-green-500 border-green-500 text-white hover:bg-green-500 font-semibold w-12"
                  type="submit"
                >
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white">
          ...
          <Form {...formClassToClassRoom}>
            <form
              onSubmit={formClassToClassRoom.handleSubmit(
                handleSubmitClassToClassRoom
              )}
            >
              <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Input
                          ...
                          {...field}
                          className={
                            formClassToClassRoom.formState.errors.nome
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <select
                            {...field}
                            className={
                              formClassToClassRoom.formState.errors.classeId
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <select
                            ...
                            {...field}
                            className={
                              formClassToClassRoom.formState.errors.turnoId
                                ?.message && `${animateShake}  select-error`
                            }
                            onChange={(e) => {
                              field.onChange(parseInt(e.target.value));
              ...
              <div className="grid gap-2">
                ...
                <div className="">
                  ...
                  <p className="indent-2 text-justify text-xs text-pretty">
                    {dataClassRoomId?.data?.localizacao}
                  </p>
                </div>
              </div>
            </div>
  ...
  return (
    <section className="m-0 w-screen h-screen  bg-gray-50">
      ...
      {postClassLevel === 1 && <AlertSucesso message={postClassError} />}
      {postClassLevel === 2 && <AlertErro message={postClassError} />}
                ...
                <Form {...formCreate}>
                  <form onSubmit={formCreate.handleSubmit(handleSubmitCreate)}>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <Input
                                ...
                                {...field}
                                className={
                                  formCreate.formState.errors.capacidade
                                    ?.message && `${animateShake} select-error`
                                }
                                min="0"
                                onChange={(e) => {
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <Textarea
                                ...
                                {...field}
                                className={
                                  formCreate.formState.errors.localizacao
                                    ?.message &&
                                  `${animateShake} select-error active:outline-none`
                                }
                              />
                              <FormMessage className="text-red-500 text-xs" />
                            </FormItem>
                    ...
                    <DialogFooter>
                      <Button
                        title="cadastrar"
                        className="responsive -button bg-blue-500 border-blue-500 text-white hover:bg-blue-500 font-semibold w-12"
                        type="submit"
                      >
                        <SaveIcon className="w-4 h-4 sm:w-4 sm:h-5 md:w-4 md:h-4 lg:w-5 lg:h-5 xl:w-5 xl:h-7  absolute text-white font-extrabold" />
                      </Button>
