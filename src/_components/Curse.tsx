...
import {
  ...
  usePostCurse,
  usePostDisMatchSubjectToCurse,
  usePostGradeToCurse,
  usePostMatchSubjectToCurse,
  usePutCurse,
...
export default function Curse() {
  ...
  const disciplinas = subjects?.pages.flatMap((page) => page?.data) ?? [];
  ...
  const { postGradeCurse, postGradeError, postGradeLevel } =
    usePostGradeToCurse();

  const handleSubmitConnectGrade = async (
    data: z.infer<typeof TFormConnectGrade>,
    e
  ) => {
    console.log(data);
    e.preventDefault();
              ...
              <div className="flex flex-col w-full py-4 bg-white">
                        ...
                        <Input
                          ...
                          className={
                            formUpdate.formState.errors.nome?.message
                              ...
                              : 'w-full text-md border-2 border-gray-300 text-gray-600 focus:text-blue-600 focus:font-semibold focus:border-sky-500 py-4 mb-2'
                          }
                          {...field}
                        />
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Textarea
                          id="descricao"
                          className={
                            formUpdate.formState.errors.descricao?.message
                              ? 'animate-shake animate-once animate-duration-150 animate-delay-100 w-full text-md border-2 border-red-300 text-red-500 focus:text-red-600 font-semibold focus:border-red-500 py-4 mb-2'
                              : 'w-full text-md border-2 border-gray-300 text-gray-600 focus:text-blue-600 focus:font-semibold focus:border-sky-500 py-4 mb-2'
                          }
                          placeholder="Dê uma descrição ao curso."
                          {...field}
                        />
                        <FormMessage className="text-red-500 text-xs" />
                      </FormItem>
                ...
                <div className="w-full">
                  <Label
                    ...
                    className="text-blue-500 text-lg font-semibold"
                  >
                    Ano de Duração<span className="text-red-500">*</span>
                  </Label>
                  <FormField
                    control={formUpdate.control}
                    name="duracao"
                    render={({ field }) => (
                      <FormItem>
                        <Input
                          ...
                          type="number"
                          className={
                            formUpdate.formState.errors.duracao?.message
                              ? 'animate-shake animate-once animate-duration-150 animate-delay-100 w-full text-md border-2 border-red-300 text-red-500 focus:text-red-600 font-semibold focus:border-red-500 py-4 mb-2'
                              : 'w-full text-md border-2 border-gray-300 text-gray-600 focus:text-blue-600 focus:font-semibold focus:border-sky-500 py-4 mb-2'
                          }
                          {...field}
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white">
          <DialogHeader>
            ...
            <DialogDescription>
              <p className="text-base text-gray-800">
                Adicione Uma Classe ao curso selecionado e em seguida click em{' '}
          ...
          <Form {...formConnectGrade}>
            <form
              onSubmit={formConnectGrade.handleSubmit(handleSubmitConnectGrade)}
            >
              <div className="flex flex-col w-full py-4 bg-white">
                <div className="w-full">
                  <label htmlFor="nome">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Input
                          ...
                          {...field}
                          className={
                            formConnectGrade.formState.errors.nome?.message &&
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Input
                          ...
                          {...field}
                          className={
                            formConnectGrade.formState.errors.ordem?.message &&
                            `${animateShake} input-error`
                          }
                          min="0"
                          onChange={(e) => {
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Input
                          ...
                          {...field}
                          className={
                            formConnectGrade.formState.errors.valorMatricula
              ...
              <DialogFooter>
                <Button
                  ...
                  onClick={() => {
                    formConnectGrade.setValue('disciplinas', selectedValues);
                  }}
                  type="submit"
                >
                  <SaveIcon className="w-5 h-5 absolute text-white font-extrabold" />
          ...
          <PopoverContent className="w-80 bg-white">
            <div className="grid gap-4">
              <div className="space-y-2">
                <h4 className="font-medium leading-none text-gray-800">
                  Dados do Curso
                </h4>
              ...
              <div className="grid gap-2">
                <div className="">
                  ...
                  <p className="indent-2 text-justify text-xs text-pretty">
                    {dataCurseId?.data?.descricao}
                  </p>
                </div>
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <Input
                                  ...
                                  type="number"
                                  className={
                                    formCreate.formState.errors.duracao?.message
                                      ? 'animate-shake animate-once animate-duration-150 animate-delay-100 w-full text-md border-2 border-red-300 text-red-500 focus:outline-none focus:text-red-600 font-semibold  focus:border-red-500 py-4 mb-2'
                                      : 'w-full text-md border-2 border-gray-300 text-gray-600 focus:outline-none focus:text-blue-600 focus:font-semibold focus:border-sky-500 py-4 mb-2'
                                  }
                                  {...field}
                                  onChange={(e) => {
                                    field.onChange(parseInt(e.target.value));
