      ...
      <div className="w-[80%] mx-auto">
        <div className="sm:flex sm:items-center sm:justify-between">
          <a href="#" className="flex items-center mb-4 sm:mb-0 space-x-1 rtl:space-x-reverse">
            ...
            <span className="self-center md:text-md lg:text-lg xl:text-xl  whitespace-nowrap text-gray-600">
              Instituto Politecnico Privado Ulumbo
            </span>
          </a>
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium sm:mb-0 text-gray-600">
            <li>
