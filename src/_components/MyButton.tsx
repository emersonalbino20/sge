...
export function SubmitButton(Icon) {
	return (
		<>
			<Save className={ClassIcon} />
			<Button className="h-8 px-5 bg-green-600 text-white font-semibold hover:bg-green-500 rounded-sm border-green-600"></Button>
		</>
	);
}
...
export function CombineButton() {
	return (
		<>
			<Link2 className={ClassIcon} />
			<Button className="h-8 px-5 bg-yellow-600 text-white font-semibold hover:bg-yellow-500 rounded-sm border-yellow-600"></Button>
		</>
	);
}
...
export function TrashButton() {
	return (
		<>
			<Trash2 className={ClassIcon} />
			<Button className="h-8 px-5 bg-red-600 text-white font-semibold hover:bg-red-500 rounded-sm border-red-600"></Button>
		</>
	);
}
...
export function LibraryButton() {
	return (
		<>
			<LucideLibrary className={ClassIcon} />
...
export function GradeButton() {
	return (
		<>
			<GraduationCap className={ClassIcon} />
			<Button className="h-8 px-5 bg-blue-600 text-white font-semibold hover:bg-blue-500 rounded-sm border-blue-600"></Button>
		</>
	);
}
