...
export const animateShake = 'animate-shake animate-once animate-duration-150 animate-delay-100;'

export const animateFadeLeft = 'animate-fade-left animate-once animate-duration-[550ms] animate-delay-[400ms] animate-ease-in';
