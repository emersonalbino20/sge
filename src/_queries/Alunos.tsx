import axios from 'axios';
    ...
    export const getAlunosPorTurma = (classe, turma) =>{
        return axios.get( `http://localhost:8000/api/classes/${classe}/alunos?turmaId=${turma}`);
    }

    export const getAlunosNotas = (aluno, trimestre, classe) =>{
        return axios.get( `http://localhost:8000/api/alunos/${aluno}/notas?trimestreId=${trimestre}&classeId=${classe}`);
    }
