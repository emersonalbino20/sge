...
const GlobalSearchPage = lazy(() => import('../_pages/GlobalSearchPage'));
const SettingsPage = lazy(() => import('../_pages/SettingsPage'));
      ...
      >
        <Routes>
          ...
          <Route element={<PrivateRoutes />}>
            ...
            />
            <Route path="/GlobalSearchPage" element={<GlobalSearchPage />} />
